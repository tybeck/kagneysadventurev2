...
.defines(function() {
  ...
  EntityPlayer = ig.Entity.extend({
    ...
    'setCurrentSkin': function setCurrentSkin() {
    ...
    'gotoNextSkin': function gotoNextSkin() {
    ...
    'gotoPreviousSkin': function gotoPreviousSkin() {
    ...
    update: function() {
      ...
      if(!ig.game.gameComplete && ig.isPlaying) {
        ...
        if(ig.input.pressed('shoot')) {
          ...
          ig.game.spawnEntity(EntityFireball, this.pos.x, 
            this.pos.y + 40, {
